...
design.rSC <- function(n = 1, phase.design = NULL, m = list(50), s = list(10), prob = list(0.5), trend = list(0), level = list(0), slope = list(0), rtt = list(0.80), concise = TRUE, extreme.p = list(0), extreme.d = c(-4,-3), missing.p = list(0), distribution = "normal", MT = 20, B.start = 6) {
...
create.rSC <- function(n = 1, MT = 20, B.start = 6, design = NULL, m = 50, s = 10, prob = 0.5, d.trend = 0, d.level = 0.0, d.slope = 0.0, rtt = 0.80, round = NA, extreme.p = 0, extreme.d = c(-4,-3), missing.p = 0, distribution = "normal", random.names = FALSE) {
